"""Parameters for rolling-average StockLSTM model and training loop.
...
class RollingLSTMModelParams:
    """Hyperparameters defining the StockLSTM architecture for rolling targets.
...
@dataclass(frozen=True)
class RollingLSTMTrainingParams:
    """Hyperparameters and configuration settings for rolling LSTM training.

    Mirrors ExactLSTMTrainingParams to ensure fair comparison.
